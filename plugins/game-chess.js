...
*chess [dari] [ke]* - Melakukan langkah dalam permainan catur (notasi catur)

*Contoh langkah:*
- *e2 e4* - Pindahkan pion dari e2 ke e4
- *g1 f3* - Pindahkan kuda dari g1 ke f3
- *d2 d4* - Pindahkan pion dari d2 ke d4
- *b8 c6* - Pindahkan kuda dari b8 ke c6
...
- Ketik *chess start* untuk memulai permainan setelah dua pemain bergabung.
- Ketik *chess e2 e4* untuk melakukan langkah pion dari e2 ke e4.

Untuk melangkah, cukup tuliskan posisi catur awal dan posisi tujuan dengan format \`[dari] [ke]\`, misalnya: \`e2 e4\` atau \`g1 f3\`.
`, m)
    }
