let handler = async (m, { conn }) => {
  await conn.sendFile(
    m.chat, 
    pickRandom(global.reflections), 
    'reflection.jpeg', 
    'Here is your reflection for today. Take it as a lesson for the future...', 
    m
  )
}

handler.help = ['reflection']
handler.tags = ['internet']
handler.command = /^(reflection)$/i
handler.owner = false
handler.mods = false
